...
var woolthread = func {
 ...
 if( getprop("sim/model/MRX13/with-woolthread" ) ) {
   ...
   if( deflection_aero < 1 ) {
     ...
     # Hence, alpha_gravity has to be adapted to prevent wrong "intermediate"-values for the mixed aero-gravity calculation!
